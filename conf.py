...
BLOG_AUTHOR = "virux(mhs)"  # (translatable)
BLOG_TITLE = "LinuxKhan"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://linuxkhan.ir/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http:linuxkhan.ir/"

BLOG_EMAIL = "viruxxx8080@gmail.com"
BLOG_DESCRIPTION = "Whatever you should not know"  # (translatable)
